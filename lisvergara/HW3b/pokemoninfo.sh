...
echo "Searching for Pokémon Red..."

grep -nr "Pokémon Red Version" $1
...
touch allplatforms.ordered.csv 
sort -k 2,2 allplatforms.csv >> allplatforms.ordered.csv 
